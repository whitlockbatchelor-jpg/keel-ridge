...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    heroImage: "/images/destinations/tajikistan/pamir-mountain-peaks.jpg",
    gallery: [
      { src: "/images/destinations/tajikistan-hero.jpg", alt: "The Pamir Highway winding through Central Asia's highest plateaus" },
      { src: "/images/destinations/tajikistan/pamir-mountain-peaks.jpg", alt: "Steep snow-covered peaks in the Pamir Mountains" },
      { src: "/images/destinations/tajikistan/high-altitude-clouds-snow.jpg", alt: "High-altitude cloudscape over snow-covered ridgeline" },
      { src: "/images/destinations/tajikistan/sun-through-snow-ridge.jpg", alt: "Sun breaking through clouds above a Pamir snow ridge" },
      { src: "/images/destinations/tajikistan/glacial-valley-stream.jpg", alt: "Glacial stream winding through a remote mountain valley" },
    ],
    description: [
  ...
  },
  {
    ...
    heroImage: "/images/destinations/marquesas/volcanic-coastline-aerial.jpg",
    gallery: [
      { src: "/images/destinations/marquesas-hero.jpg", alt: "Dramatic volcanic spires of the Marquesas rising from the Pacific" },
      { src: "/images/destinations/marquesas/volcanic-coastline-aerial.jpg", alt: "Aerial view of volcanic coastline and turquoise waters" },
      { src: "/images/destinations/marquesas/tropical-bay-anchorage.jpg", alt: "Sheltered tropical bay with sailing anchorage" },
      { src: "/images/destinations/marquesas/island-ridgeline-clouds.jpg", alt: "Island ridgeline draped in clouds" },
      { src: "/images/destinations/marquesas/ocean-passage-sunset.jpg", alt: "Ocean passage at sunset between islands" },
      { src: "/images/destinations/marquesas/blue-water-sailing.jpg", alt: "Blue-water sailing in the open Pacific" },
      { src: "/images/destinations/marquesas/cathedral-cliffs-bay.jpg", alt: "Cathedral cliffs rising above a sheltered bay" },
      { src: "/images/destinations/marquesas/waterfall-jungle-valley.jpg", alt: "Waterfall cascading through lush jungle valley" },
      { src: "/images/destinations/marquesas/palm-lined-shore.jpg", alt: "Palm-lined shore on a remote Marquesan beach" },
      { src: "/images/destinations/marquesas/rocky-headland-waves.jpg", alt: "Rocky headland with waves crashing below" },
      { src: "/images/destinations/marquesas/volcanic-peak-clouds.jpg", alt: "Volcanic peak shrouded in tropical clouds" },
      { src: "/images/destinations/marquesas/turquoise-lagoon-reef.jpg", alt: "Turquoise lagoon over shallow reef" },
      { src: "/images/destinations/marquesas/dramatic-sea-cliffs.jpg", alt: "Dramatic sea cliffs dropping into the ocean" },
      { src: "/images/destinations/marquesas/remote-beach-cove.jpg", alt: "Remote beach cove accessible only by boat" },
      { src: "/images/destinations/marquesas/island-sunset-silhouette.jpg", alt: "Island silhouette at sunset across the Pacific" },
    ],
    description: [
  ...
  },
  {
    ...
    heroImage: "/images/destinations/azores/crater-lake-caldera.jpg",
    gallery: [
      { src: "/images/destinations/azores-hero.jpg", alt: "Volcanic ridgelines of the Azores rising from the Atlantic" },
      { src: "/images/destinations/azores/crater-lake-caldera.jpg", alt: "Crater lake nested inside a collapsed caldera" },
      { src: "/images/destinations/azores/volcanic-beach-coastline.jpg", alt: "Volcanic beach along the Azorean coastline" },
      { src: "/images/destinations/azores/valley-river-green.jpg", alt: "Lush green valley with river winding through" },
      { src: "/images/destinations/azores/mountain-ridgeline-trail.jpg", alt: "Mountain biking trail along a volcanic ridgeline" },
      { src: "/images/destinations/azores/volcanic-peaks-clouds.jpg", alt: "Volcanic peaks wrapped in Atlantic clouds" },
      { src: "/images/destinations/azores/sete-cidades-lake.jpg", alt: "Sete Cidades twin lakes from the caldera rim" },
      { src: "/images/destinations/azores/mountain-lake-panorama.jpg", alt: "Mountain lake panorama in the Azorean highlands" },
    ],
    description: [
